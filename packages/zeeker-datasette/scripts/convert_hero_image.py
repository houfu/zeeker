...
def convert_hero_image(input_path: str, output_dir: str = "static/images"):
    ...
    sizes = {
        "desktop": {"size": (2560, 1440), "quality_webp": 85, "quality_png": 95, "suffix": ""},
        "mobile": {"size": (1280, 720), "quality_webp": 80, "quality_png": 90, "suffix": "-mobile"},
        "tablet": {
            "size": (1920, 1080),
            "quality_webp": 82,
            "quality_png": 92,
        ...
        with Image.open(input_path) as img:
            ...
            for size_name, config in sizes.items():
                ...
                resized = ImageOps.fit(
                    resized, config["size"], Image.Resampling.LANCZOS, centering=(0.5, 0.5)
                )
                ...
                resized.save(png_path, "PNG", optimize=True, compress_level=6)
